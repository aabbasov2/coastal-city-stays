...
export default function Home() {
  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <section className="relative h-[90vh] bg-cover bg-center bg-no-repeat">
      ...
      <section className="relative py-16 px-4 overflow-hidden bg-gradient-to-br from-sky-500 via-sky-600 to-cyan-600">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-white/95 rounded-2xl hover:shadow-xl transition-all duration-300">
